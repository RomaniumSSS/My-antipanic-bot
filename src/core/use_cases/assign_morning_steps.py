...
# AICODE-NOTE: Расширен список для большей вариативности (UX fix 17.12.2025)
BODY_ACTIONS: list[str] = [
    ...
    "Пройдись по комнате или коридору 2 минуты, считая шаги до 120",
    ...
    "Сделай 5 наклонов головы вперёд-назад, влево-вправо. Медленно, без рывков",
    "Пройдись по комнате задом наперёд 1 минуту — перезагрузит мозг",
    "Напряги все мышцы на 5 секунд, потом расслабься. Повтори 3 раза",
    "Попрыгай на месте 20 раз или сделай 10 прыжков с хлопком",
    "Умойся холодной водой или протри лицо влажной салфеткой",
]
