...
**Проблема**: Кнопка "Изменить" удаляет всю цель вместо редактирования этапов

**Решение**:
1. Кнопка "Изменить этапы" → список этапов с возможностью:
   - Переименовать этап
   - Удалить этап
   - Добавить новый этап
2. Отдельная кнопка "Удалить цель" с подтверждением
